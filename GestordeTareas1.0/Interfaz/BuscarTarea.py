...
class Ui_BuscarTareaMainWindow(object):
    ...
    def setupUi(self, MainWindow,id_usuario,nombre):
        ...
        # Reemplaza el botón BuscarTarea por una entrada de texto
        self.BuscarTarea = QtWidgets.QLineEdit(self.centralwidget)  # Cambiar QPushButton a QLineEdit
        ...
        self.BuscarTarea.setPlaceholderText("Escribe aquí para buscar una tarea...")  # Texto de ayuda en el campo
        self.BuscarTarea.returnPressed.connect(lambda: self.mostrar_Buscar(id_usuario))
    ...
    def mostrar_Buscar(self,id_usuario):
        print("Llamando a obtener_tareas_usuario()...")
        escritorio = Escritorio()
        texto = self.BuscarTarea.text()
        tarea_obj = Busqueda()
        tareas = tarea_obj.buscar_tareas(id_usuario,texto)  # Cambia 30 por el ID de usuario correcto
    ...
    def AbrirAgregarTarea(self,id_usuario):
        ...
        self.ui.setupUi(self.window,id_usuario,self.mostrar_Buscar)  # Inicializar la segunda ventana
        self.window.show()
    ...
    def EliminarTarea(self,id_tarea,id_usuario):
        ...
        self.ui.setupUi(self.window,id_tarea,id_usuario,self.mostrar_Buscar)  # Inicializar la segunda ventana
        self.window.show()
